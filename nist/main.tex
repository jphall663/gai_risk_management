...
% define policies (easy) and procedures (difficult)
% -- refer to appendix A for how existing policies can be aligned to AI/GAI risk materials  
% coordination with security, fair lending/HR, data privacy, data management/governance, IT 
...
% update policies, easy 
% - acceptable/prohibited use policy/end use compute policy as catch all 
% - provide bullets
% -- Anonymous Use
...
% -- RAG, fine-tuning?
% - validation, refer to appendices C, D, F, G, H
% - mitigation
% - decommission
