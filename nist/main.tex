...
\begin{table}[H]
	\caption*{Table D.1: Common adversarial prompting techniques organized by trustworthy characteristic.}
	\label{tab:rt_by_tc}
	\scriptsize
...
\begin{table}[H]
	\caption*{Table D.2: Common adversarial prompting techniques organized by generative AI risk.}
