...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\hline	
		\textbf{Measure} & \makecell[l]{
			\textbullet\hspace{3pt} Auto-completion prompts to elicit CBRN information or synthesis thereof. \\ 
			\textbullet\hspace{3pt} Role-playing, ingratiation/reverse psychology, pros and cons, multitasking prompts. \\ 
			\textbullet\hspace{3pt} Repeat this. \\ 
			\textbullet\hspace{3pt} Augment prompts with word or character play to increase effectiveness. \\ 
			\textbullet\hspace{3pt} Frame prompts with software, coding, or AI references to increase effectiveness. \\
		} 
		& \makecell[l]{
			\textbullet\hspace{3pt} Enable access to ground truth information. \\ 
			\textbullet\hspace{3pt} Complex logic, multi-tasking, niche-seeking.  \\ 
			\textbullet\hspace{3pt} Time perplexity. \\ 
			\textbullet\hspace{3pt} Test planning and decision making. \\ 
			\textbullet\hspace{3pt} Loaded/leading questions. \\ 
			\textbullet\hspace{3pt} Citation for information generated in output responses. \\ 
			\textbullet\hspace{3pt} Calculations or query numeric statistics. \\
		} 
		& \makecell[l]{
			\textbullet\hspace{3pt} Role-playing, ingratiation/reverse psychology, pros and cons, multitasking prompts. \\ 
			\textbullet\hspace{3pt} Repeat this. \\ 
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\hline	
		\textbf{Measure} & \makecell[l]{
			\textbullet\hspace{3pt} Availability attacks (e.g., sponge example attacks). \\ 
			\textbullet\hspace{3pt} Role-playing, ingratiation/reverse psychology, pros and cons, multitasking prompts. \\
		}
		& \makecell[l]{
		\textbullet\hspace{3pt} Assess system for instances of anthropomorphization. \\ 
		\textbullet\hspace{3pt} Assess system instructions. \\ 
		\textbullet\hspace{3pt} Role-playing, ingratiation/reverse psychology, pros and cons, multitasking prompts. \\
		}
		& \makecell[l]{
			\textbullet\hspace{3pt} Test system capabilities to create deep fakes. \\ 
			\textbullet\hspace{3pt} Test system capabilities to construct persuasive arguments. \\ 
			\textbullet\hspace{3pt} Test system capabilities for planning dis- or mis-information campaigns. \\ 
			\textbullet\hspace{3pt} Loaded/leading questions.  \\ 
			\textbullet\hspace{3pt} Test prompts using role-playing, ingratiation/reverse psychology, pros and cons, multitasking prompts. \\ 
			\textbullet\hspace{3pt} Augment prompts with word or character play to increase effectiveness.  \\ 
			\textbullet\hspace{3pt} Frame prompts with software, coding, or AI references to increase effectiveness. \\
		} 
		& \makecell[l]{
			\textbullet\hspace{3pt} Attempt anonymous access of system.  \\ 
			\textbullet\hspace{3pt} Audit system dependencies, supply chains, and third party components.  \\ 
			\textbullet\hspace{3pt} Confidentiality attacks (e.g., membership inference) .  \\ 
			\textbullet\hspace{3pt} Integrity attacks (e.g., data poisoning, prompt injection).  \\ 
			\textbullet\hspace{3pt} Availability attacks (e.g., sponge example attacks). \\ 
			\textbullet\hspace{3pt} Random attacks.  \\ 
			\textbullet\hspace{3pt} Multi-tasking prompts, pros and cons prompts, role-playing prompts (e.g., "DAN", "Developer Mode"), content exhaustion/niche-seeking prompts, or ingratiation/reverse psychology prompts.  \\ 
			\textbullet\hspace{3pt} Test system capabilities to plan or assist in information security attacks. \\ 
			\textbullet\hspace{3pt} Frame prompts with software, coding, or AI references to increase effectiveness. \\ 
			\textbullet\hspace{3pt} Augment prompts with word or character play to increase effectiveness. \\
		}
		\\
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		& \makecell[l]{
			\textbullet\hspace{3pt} Assess confabulation and other performance repeatedly across groups. \\ 
			\textbullet\hspace{3pt} Demographic assignment of users by the system. \\ 
			\textbullet\hspace{3pt} Data poisoning for homogenization. \\ 
			\textbullet\hspace{3pt} Counterfactual prompts, pros and cons prompts, role-playing prompts, low context prompts. \\ 
			\textbullet\hspace{3pt} Loaded/leading questions.  \\ 
			\textbullet\hspace{3pt} Repeat this. \\
		}
		& \makecell[l]{
			\textbullet\hspace{3pt} Audit system dependencies, supply chains, and third party components. \\ 
			\textbullet\hspace{3pt} Red-teaming for data privacy, information security, intellectual property, and obscenity. \\ 
			\textbullet\hspace{3pt} Review third-party documentation, materials, and software artifacts. \\
		}
		\\
		\hline
		\textbf{Manage} & & & & \\
